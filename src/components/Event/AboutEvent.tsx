    ...
    <div className="w-full max-w-[450px] md:max-w-[800px] mt-5 flex flex-col items-center gap-x-4">
      ...
      <section className="prose prose-p:text-lg  prose-li:text-lg prose-h4:text-lg flex flex-col justify-center w-full mt-5 ">
        <p>
          ...
          winning strategies that propelled Sourav to victory in one of India's
          most prestigious hackathons.
        </p>
        <p>
          Discover the secrets behind Sourav's success as he shares his
        ...
        <p>
          Whether you're a seasoned Hackathon participant or just starting your
          journey, this event provides an invaluable opportunity to learn from a
          proven expert. Don't miss this chance to gain the competitive edge and
        ...
        <p>
          ...
          >
            Whatts App <span className=" -rotate-[45deg]">-&gt;</span>
          </Link>
        </p>
      </section>
    </div>
